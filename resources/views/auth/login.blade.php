<x-auth title="Sign In - Medica">
    ...
    <div class="sign_container">
        ...
        <form  action="{{ route('login') }}" method="POST">
            ...
            <div class="sign_input-group" id="email-group">
                <label for="email">Email Address</label>
                <input type="email" id="email" name="email" placeholder="Enter your Email" required oninput="showPasswordField()">
            </div>

            <div class="sign_input-group" id="password-group" style="display: none;">
                <label for="password">Password</label>
                <div style="position: relative;">
                    <input type="password" id="password" name="password" placeholder="Enter Password" required>
                    <span class="sign_toggle-password" onclick="togglePassword('password', this)"
            ...
            <button class="sign_button" type="submit">Sign In</button>
        </form>
